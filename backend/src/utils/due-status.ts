import type { DueStatus, DueStatusResult } from "@/types/due";
...
export function validateReminderMinutes(minutes: number | null | undefined): boolean {
  if (minutes === null || minutes === undefined) return true;
  return [5, 10, 15, 30, 60, 120, 1440].includes(minutes);
}
