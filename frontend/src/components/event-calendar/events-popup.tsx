...
export function EventsPopup({
  ...
  return (
    <div
      className="overflow-auto absolute z-50 w-80 max-h-96 rounded-md border shadow-lg bg-background"
      ref={popupRef}
      style={{
    ...
    >
      <div className="flex sticky top-0 justify-between items-center p-3 border-b bg-background">
